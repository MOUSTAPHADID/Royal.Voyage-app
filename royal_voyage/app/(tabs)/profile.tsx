  ...
  const menuSections = [
    {
      ...
      items: [
        ...
        { icon: "building.2.fill", label: language === "ar" ? "الحساب التجاري" : language === "fr" ? "Compte Professionnel" : "Business Account", value: "", onPress: () => router.push("/business/login" as any) },
        { icon: "briefcase.fill", label: language === "ar" ? "تسجيل شريك" : language === "fr" ? "Inscription Partenaire" : "Partner Registration", value: "", onPress: () => router.push("/partners/register" as any) },
      ],
    },
    {
