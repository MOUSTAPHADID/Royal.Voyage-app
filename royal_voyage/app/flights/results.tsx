...
export default function FlightResultsScreen() {
  ...
  const { data: duffelResult, isLoading, isError } = trpc.amadeus.searchFlights.useQuery(
    {
  ...
  const flexQuery0 = trpc.amadeus.searchFlights.useQuery({ originCode: params.originCode || "", destinationCode: params.destinationCode || "", departureDate: flexDates[0] || "", adults: parseInt(params.passengers || "1", 10), children: parseInt(params.children || "0", 10), infants: parseInt(params.infants || "0", 10), max: 3 }, { enabled: isFlexible && !!flexDates[0], retry: 1 });
  const flexQuery1 = trpc.amadeus.searchFlights.useQuery({ originCode: params.originCode || "", destinationCode: params.destinationCode || "", departureDate: flexDates[1] || "", adults: parseInt(params.passengers || "1", 10), children: parseInt(params.children || "0", 10), infants: parseInt(params.infants || "0", 10), max: 3 }, { enabled: isFlexible && !!flexDates[1], retry: 1 });
  const flexQuery2 = trpc.amadeus.searchFlights.useQuery({ originCode: params.originCode || "", destinationCode: params.destinationCode || "", departureDate: flexDates[2] || "", adults: parseInt(params.passengers || "1", 10), children: parseInt(params.children || "0", 10), infants: parseInt(params.infants || "0", 10), max: 3 }, { enabled: isFlexible && !!flexDates[2], retry: 1 });
  const flexQuery3 = trpc.amadeus.searchFlights.useQuery({ originCode: params.originCode || "", destinationCode: params.destinationCode || "", departureDate: flexDates[3] || "", adults: parseInt(params.passengers || "1", 10), children: parseInt(params.children || "0", 10), infants: parseInt(params.infants || "0", 10), max: 3 }, { enabled: isFlexible && !!flexDates[3], retry: 1 });
  const flexQuery4 = trpc.amadeus.searchFlights.useQuery({ originCode: params.originCode || "", destinationCode: params.destinationCode || "", departureDate: flexDates[4] || "", adults: parseInt(params.passengers || "1", 10), children: parseInt(params.children || "0", 10), infants: parseInt(params.infants || "0", 10), max: 3 }, { enabled: isFlexible && !!flexDates[4], retry: 1 });
  const flexQuery5 = trpc.amadeus.searchFlights.useQuery({ originCode: params.originCode || "", destinationCode: params.destinationCode || "", departureDate: flexDates[5] || "", adults: parseInt(params.passengers || "1", 10), children: parseInt(params.children || "0", 10), infants: parseInt(params.infants || "0", 10), max: 3 }, { enabled: isFlexible && !!flexDates[5], retry: 1 });
  const flexQuery6 = trpc.amadeus.searchFlights.useQuery({ originCode: params.originCode || "", destinationCode: params.destinationCode || "", departureDate: flexDates[6] || "", adults: parseInt(params.passengers || "1", 10), children: parseInt(params.children || "0", 10), infants: parseInt(params.infants || "0", 10), max: 3 }, { enabled: isFlexible && !!flexDates[6], retry: 1 });
     ...
     >
      ...
      <View style={styles.cardHeader}>
        ...
        <View style={styles.priceBox}>
          {/* السعر الإجمالي */}
          {/* toMRU(item.price, item.currency || "EUR") */}
