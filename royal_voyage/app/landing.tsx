...
// Removed hardcoded prices - use real API data instead
const POPULAR_DESTINATIONS: any[] = [];
...
// ── Today's Deals ──────────────────────────────────────────────────────────
// Removed hardcoded prices - use real API data instead
const TODAYS_DEALS_AR: any[] = [];
const TODAYS_DEALS_EN: any[] = [];

// Removed airline logos - no hardcoded partner branding
// Removed airline logos - no hardcoded partner branding
const AIRLINE_LOGOS: any[] = [];

// Removed the following sections:
// - All airline logos (no hardcoded partner branding)
// - Duffel Technology Partner section
    ...
    <View style={{ flex: 1, backgroundColor: "#fff" }}>
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ flexGrow: 1 }} stickyHeaderIndices={[0]}>
        ...
        <View style={styles.footerContainer}>
          ...
          {/* Airline Partners and Duffel sections removed - no hardcoded partner branding */}
